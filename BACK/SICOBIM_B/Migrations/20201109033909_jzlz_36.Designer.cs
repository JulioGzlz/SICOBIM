...
namespace SICOBIM_B.Migrations
{
    ...
    [Migration("20201109033909_jzlz_36")]
    partial class jzlz_36
    {
            ...
            modelBuilder.Entity("SICOBIM_B.Entities.TblBienes", b =>
                {
                    ...
                    b.Property<int?>("IProveedorTblProveedorId")
                        .HasColumnType("integer");

                    b.Property<int?>("IdAreaServicioid")
                        .HasColumnType("integer");

                    b.Property<int?>("IdClaveCabmsTblClaveCabmsId")
                        .HasColumnType("integer");

                    b.Property<int?>("IdClaveSaicaTblClaveSaicaId")
                        .HasColumnType("integer");

                    b.Property<int?>("IdContratoBienTblContratoBienId")
                        .HasColumnType("integer");

                    b.Property<int?>("IdFacturasTblFacturasId")
                        .HasColumnType("integer");

                    b.Property<int?>("IdFederalizacionTblFederalizacionId")
                        .HasColumnType("integer");

                    b.Property<int?>("IdInventariosTblInventariosId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IProveedorTblProveedorId");

                    b.HasIndex("IdAreaServicioid");

                    b.HasIndex("IdClaveCabmsTblClaveCabmsId");

                    b.HasIndex("IdClaveSaicaTblClaveSaicaId");

                    b.HasIndex("IdContratoBienTblContratoBienId");

                    b.HasIndex("IdFacturasTblFacturasId");

                    b.HasIndex("IdFederalizacionTblFederalizacionId");

                    b.HasIndex("IdInventariosTblInventariosId");
            ...
            modelBuilder.Entity("SICOBIM_B.Entities.TblBienesSistemas", b =>
                {
                    ...
                    b.Property<int?>("IdProveedorTblProveedorId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdProveedorTblProveedorId");
            ...
            modelBuilder.Entity("SICOBIM_B.Entities.TblInstrumentalMedico", b =>
                {
                    ...
                    b.Property<int?>("IdClaveCambsTblClaveCabmsId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdClaveCambsTblClaveCabmsId");
            ...
            modelBuilder.Entity("SICOBIM_B.Entities.TblBienes", b =>
                {
                    b.HasOne("SICOBIM_B.Entities.TblProveedor", "IProveedor")
                        .WithMany("tblBienes")
                        .HasForeignKey("IProveedorTblProveedorId");
                    ...
                    b.HasOne("SICOBIM_B.Entities.TblClaveCabms", "IdClaveCabms")
                        .WithMany("tblBienes")
                        .HasForeignKey("IdClaveCabmsTblClaveCabmsId");

                    b.HasOne("SICOBIM_B.Entities.TblClaveSaica", "IdClaveSaica")
                        .WithMany("tblBienes")
                        .HasForeignKey("IdClaveSaicaTblClaveSaicaId");

                    b.HasOne("SICOBIM_B.Entities.TblContratoBien", "IdContratoBien")
                        .WithMany("tblBienes")
                        .HasForeignKey("IdContratoBienTblContratoBienId");
                    ...
                    b.HasOne("SICOBIM_B.Entities.TblFederalizacion", "IdFederalizacion")
                        .WithMany("TblBienes")
                        .HasForeignKey("IdFederalizacionTblFederalizacionId");

                    b.HasOne("SICOBIM_B.Entities.TblInventarios", "IdInventarios")
                        .WithMany("tblBienes")
                        .HasForeignKey("IdInventariosTblInventariosId");
            ...
            modelBuilder.Entity("SICOBIM_B.Entities.TblBienesSistemas", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.Entities.TblProveedor", "IdProveedor")
                        .WithMany("tblBienesSistemas")
                        .HasForeignKey("IdProveedorTblProveedorId");
            ...
            modelBuilder.Entity("SICOBIM_B.Entities.TblInstrumentalMedico", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.Entities.TblClaveCabms", "IdClaveCambs")
                        .WithMany("tblInstrumentalMedico")
                        .HasForeignKey("IdClaveCambsTblClaveCabmsId");
