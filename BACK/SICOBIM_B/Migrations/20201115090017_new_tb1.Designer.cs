...
namespace SICOBIM_B.Migrations
{
    ...
    [Migration("20201115090017_new_tb1")]
    partial class new_tb1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SICOBIM_B.TblAreaServicio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("SICOBIM_B.TblClaveCambs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("SICOBIM_B.CtrlUsuarios", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.TblAreaServicio", "IdAreaServicio")
                        .WithMany("CtrlUsuarios")
            ...
            modelBuilder.Entity("SICOBIM_B.TblBienesEquMedico", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.TblClaveCambs", "IdClaveCabms")
                        .WithMany("TblBienesEquMedico")
            ...
            modelBuilder.Entity("SICOBIM_B.TblBienesMuebles", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.TblInventarios", "IdInventarios")
                        .WithMany("TblBienesMuebles")
                    ...
                    b.HasOne("SICOBIM_B.TblProveedor", "Iproveedor")
                        .WithMany("TblBienesMuebles")
            ...
            modelBuilder.Entity("SICOBIM_B.TblInstrumentalMedico", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.TblClaveCambs", "IdClaveCambs")
                        .WithMany("TblInstrumentalMedico")
            ...
            modelBuilder.Entity("SICOBIM_B.TblResguardatarios", b =>
                {
                    ...
                    b.HasOne("SICOBIM_B.TblAreaServicio", "TblAreaServicio")
                        .WithMany("TblResguardatarios")
