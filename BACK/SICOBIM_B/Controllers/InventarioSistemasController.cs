        ...
        {
            {
                ...
                try
                {
                    ...
                    objRespuestatblFederalizacion = _businessSistemas.GuardarTblFederalizacion(tblFederalizacion);
                    ...
                    objRespuestatblInventarios = _businessSistemas.GuardarTblInventarios(tblInventarios);
                    ...
                    tblBienesSistemas.IdFederalizacionid = objRespuestatblFederalizacion.objGenerics.Id;
                    tblBienesSistemas.Descripcion = modeloInventario.Descripcion;
                    tblBienesSistemas.IdInventarioid = objRespuestatblInventarios.objGenerics.Id;
